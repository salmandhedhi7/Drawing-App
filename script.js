...
//         ctx.lineTo(e.offsetX, e.offsetY); //creating lineaccording to the mouse pointer
...
//     e.preventDefault();
//     isDrawing = true;
//     let coordinates = getCoordinates(e.touches[0]);
...
//         let coordinates = getCoordinates(e.touches[0]);
//         ctx.strokeStyle = selectedTool === "eraser" ? "#fff" : selectedColor;
//         ctx.lineTo(coordinates.x, coordinates.y); //creating lineaccording to the mouse pointer
//         ctx.stroke(); // drawing filling line with color
//     } else if (selectedTool === "rectangle") {
//         drawRect(e);
//     } else if (selectedTool === "circle") {
...
//     return{
//         x: touch.cleintX - rect.left,
//         y: touch.cleintY - rect.top,
//     };
// }
